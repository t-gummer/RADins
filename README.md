...
|        Comment section         |      `fill_equals()`      |    `Ctrl+Shift+X`    |                                                                    Fill the rest of a line with equals signs (up to 80 characters).                                                                    |
...
<!-- Make gif for more of the addins -->
